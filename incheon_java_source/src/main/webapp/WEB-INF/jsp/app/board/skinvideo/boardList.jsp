		...
		<ul id="sb-video">
			...
			<li>
				...
				<div class="tmb">
					...
					<% if (!CommonUtil.nvl(rsMap.get("YOUTUBE_CODE1")).equals("")) { %>
					<img src="https://img.youtube.com/vi/<%=CommonUtil.nvl(rsMap.get("YOUTUBE_CODE1")) %>/maxresdefault.jpg" width="<%=CommonUtil.nvl(brdMgrMap.get("THM_WIDTH_SIZE")) %>" height="<%=CommonUtil.nvl(brdMgrMap.get("THM_HEIGHT_SIZE")) %>"/>
					<% } else { %>
