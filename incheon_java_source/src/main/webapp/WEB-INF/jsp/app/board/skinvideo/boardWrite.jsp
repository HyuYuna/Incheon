					...
					<tbody>
						...
						<% if (CommonUtil.nvl(brdMgrMap.get("BRD_SKIN_CD")).equals("SKINVIDEO")) {  //비디오 스킨 사용 %>
							...
							<tr>
								<th>유튜브 코드</th>
								<td>
									<input type="text" name="youtube_code1" maxlength="50" class="inp w30" value="<%=CommonUtil.nvl(dbMap.get("YOUTUBE_CODE1"))%>">
									<br/>리스트 이미지에 노출됩니다.
								</td>
							</tr>
							<tr>
								<th>유튜브 코드</th>
								<td>
									<input type="text" name="youtube_code2"  maxlength="50" class="inp w30" value="<%=CommonUtil.nvl(dbMap.get("YOUTUBE_CODE2"))%>">
								</td>
							</tr>
							<tr>
								<th>유튜브 코드</th>
								<td>
									<input type="text" name="youtube_code3"  maxlength="50" class="inp w30" value="<%=CommonUtil.nvl(dbMap.get("YOUTUBE_CODE3"))%>">
								</td>
							</tr>
						<% } %>
