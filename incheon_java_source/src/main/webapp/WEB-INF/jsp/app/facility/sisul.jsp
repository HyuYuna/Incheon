...
<div class="pop-wrap">
	...
	<% } %>
        ...
        <ul class="tmb">
            ...
            <li style="background-image: url('https://webjangbok.incheon.go.kr<%=CommonUtil.nvl(picListMap.get("PICTURE_PATH"))%>/<%=CommonUtil.nvl(picListMap.get("PICTURE_NM"))%>');">
                <a href="https://webjangbok.incheon.go.kr<%=CommonUtil.nvl(picListMap.get("PICTURE_PATH"))%>/<%=CommonUtil.nvl(picListMap.get("PICTURE_NM"))%>" class="fancybox"></a>
            </li>
        ...
        <a href="javascript:window.open('/programs.do?menuno=<%=CommonUtil.nvl(reqMap.get("menuno"), "")%>&wcd=<%=CommonUtil.nvl(detail.get("WFFCLTY_CD")) %>','sisulpop','width=1000px,height=900px,scrollbars=yes'); void(0);" class="prgr-btn">운영 프로그램 보기 <i class="axi axi-chevron-right"></i></a>
...
<form name="sisulForm" method="post">
	...
	<input type="hidden" name="menuno" id="menuno" value="275"/>
</form>
