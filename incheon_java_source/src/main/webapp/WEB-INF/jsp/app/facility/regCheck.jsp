...
<div id="wrap">
	...
	<!-- skinlist -->
        ...
        <!-- write -->
		<form name="writeform" action="/regCheckProc.do" method="post" autocomplete="off" onsubmit="return formcheck(this)">
                ...
                <table class="table2 write w600">
                    <tbody>
                        <tr>
                            <th>예약자 성명</th>
                            <td>
                                <input type="text" name="name" id="name" class="inp" maxlength="30"/>
                            </td>
                        </tr>
                        <tr>
                            <th>연락처</th>
